...
public class ImplosionTntBlock extends TntBlock{
public ImplosionTntBlock(Settings settings){
super(settings);
}
private void primeCustomTnt(World world, BlockPos pos, @Nullable LivingEntity igniter){
if(!world.isClient){
ImplosionTntEntity tntEntity = new ImplosionTntEntity(world, pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5, igniter);
